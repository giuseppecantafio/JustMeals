    ...
    <div>
                ...
                >
                    <div class="mx-3" style="width: 18rem">
                        <router-link
                            :to="{
                                name: 'menu',
                                params: { slug: pizzeria.slug },
                            }"
                            style="color: white"
                        >
                            <div class="img-slider-container">
                                <img
                                    :src="`/storage/${pizzeria.image}`"
                            ...
                            <div class="py-3">
                                <h5 class="text-center restaurant-name-slider">
                                    {{ pizzeria.name }}
                                </h5>
                            </div>
                        </router-link>
        ...
        <section>
            <svg
                ...
                style="margin-bottom: -138px"
                viewBox="0 0 1440 320"
            >
                <path
                    fill="#EDEAEB"
                    fill-opacity="1"
                    d="M0,192L48,181.3C96,171,192,149,288,170.7C384,192,480,256,576,245.3C672,235,768,149,864,133.3C960,117,1056,171,1152,181.3C1248,192,1344,160,1392,144L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                ></path>
            </svg>
            <div class="backg">
                <div class="container consenge">
                    <section class="text-center">
                        ...
                        >
                            <div class="col">
                                <img
                                    src="https://res.cloudinary.com/glovoapp/image/fetch//q_auto/https://glovoapp.com/images/why-glovo/restaurants.svg"
                                    alt=""
                                />
                                ...
                                <p class="m-auto">
                                    Con un'ampia varietà di ristoranti puoi
                                    ordinare i tuoi piatti preferiti oppure
                                    esplora nuovi ristoranti nei dintorni!
                                </p>
                            </div>
                            <div class="col">
                                <img
                                    src="https://res.cloudinary.com/glovoapp/image/fetch//q_auto/https://glovoapp.com/images/why-glovo/delivery.svg"
                                    alt=""
                                />
                                <div class="title py-3">Consegna rapida</div>
                                <p class="m-auto">
                                    La rapidità è un nostro punto d'orgoglio.
                                    Ordina o invia qualsiasi cosa nella tua
                                    città e lo ritireremo e te lo consegneremo
                                    nel giro di qualche minuto.
                                </p>
                            </div>
                            <div class="col">
                                <img
                                    src="https://res.cloudinary.com/glovoapp/image/fetch//q_auto/https://glovoapp.com/images/why-glovo/groceries.svg"
                                    alt=""
                                />
                                <div class="title py-3">
                                ...
                                <p class="m-auto">
                                    Trova tutto ciò che ti serve! Dai
                                    supermercati ai negozi, dalle farmacie ai
                                    fioristi se è nella tua città, te lo
                                    portiamo noi.
                                </p>
                            </div>
                        </div>
                                ...
                                >
                                    <span
                                        style="
                                            ...
                                            margin-left: 25px;
                                        "
                                        >Esplora i locali intorno a te</span
                                    >
                                </router-link>
                            </div>
                        </div>
        ...
        <VueSlickCarousel v-bind="settingslow" v-if="ok">
            ...
            >
                <router-link
                    :to="{ name: 'menu', params: { slug: pizzeria.slug } }"
                >
                    <img
                        :src="`/storage/${pizzeria.image}`"
                        class="shadow card-img-top img-slider-container"
                        alt="..."
                    />
                </router-link>
            </div>
                    ...
                    >
                        <div class="col">
                            <img
                                ...
                                alt=""
                            />
                            <div class="title py-2">Diventa un rider</div>
                            <p class="m-auto">
                                Diventa il capo di te stesso! Goditi
                                flessibilità, libertà e guadagni competitivi
                                effettuando consegne con Glovo.
                            </p>
                        </div>
                        <div class="col">
                            <img
                        ...
                        <div class="col">
                            <img
                                ...
                                alt=""
                            />
                            <div class="title py-2">Lavora con noi</div>
                            <p class="m-auto">
                                Pronto per una nuova ed entusiasmante sfida? Se
                                sei ambizioso, umile e ami lavorare con gli
                                altri, mettiti in contatto con noi!
                            </p>
                        </div>
                    </div>
                </section>
...
export default {
    ...
    methods: {
        getPizzerie() {
            axios
                .get("api/restaurants?typology=2")
                .then((response) => {
        ...
        getGiapponesi() {
            axios
                .get(`api/restaurants?typology=1`)
                .then((response) => {
...
@keyframes example {
    ...
    to {
        opacity: 1;
        box-shadow: rgba(0, 0, 0, 0.56) 0px 8px 10px 4px;
    }
}
</style>
